...
const cart_routes_1 = __importDefault(require("./cart/routes/cart.routes"));
const order_routes_1 = __importDefault(require("./order/routes/order.routes"));
const wishlist_routes_1 = __importDefault(require("./wishlist/routes/wishlist.routes"));
...
// 👇 ADD THIS DEBUG ROUTE (before error handlers)
app.get("/api/debug/me", auth_1.authenticate, (req, res) => {
    res.json({
        message: "Auth ok",
        userId: req.userId,
    });
